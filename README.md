...
Java engineer going deep into **AI / ML** — building toward **RAG, LLMs, and agentic systems**, with a
focus on **cybersecurity** and **finance / investing** applications.

[![▶ Live interactive explainers](https://img.shields.io/badge/%E2%96%B6%20Live%20interactive%20explainers-1a2b4a?style=for-the-badge)](https://ai-ml-roadmap.pages.dev/illustrated/index.html)
[![AI/ML Roadmap site](https://img.shields.io/badge/AI%2FML%20Roadmap%20site-0a7d2c?style=for-the-badge)](https://ai-ml-roadmap.pages.dev/)
...
- **Computer vision** — car-damage repair-cost estimation (India)
- **AI / LLM security** (OWASP LLM Top 10) and **finance** analysis & backtesting *(research only)*

#### 📌 Featured repos

- **[ai-ml-roadmap](https://ai-ml-roadmap.pages.dev/)** — the learning site: The Path, explainers, quizzes, the Model Foundry game
